 ...
 * @author itzel
 */
public class Lobby extends javax.swing.JFrame implements IFrame {
    private static JButton botones[]=new JButton[4];
    ...
    public Lobby(Jugador jugador) {
        ...
        jugadores[1].setNombre("David");
        jugadores[2].setNombre("Fabian");
        jugadores[3].setNombre("Itzel");
        //Se ilusta el icono y el nombre de cada jugador en la pantalla
        labelIcon1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/avatar1R.png")));
    ...
    private void btnEmpezarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEmpezarActionPerformed
        try {
            ClienteHilo.jugadores=this.jugadores;
            ClienteHilo.enviarMensajeServidor("game");
    ...
    private void btnVotar3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotar3ActionPerformed
        try {
                ClienteHilo.enviarMensajeServidor("3");
            } catch (IOException ex) {
                Logger.getLogger(Lobby.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void btnVotar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotar2ActionPerformed
        try {
                ClienteHilo.enviarMensajeServidor("2");
            } catch (IOException ex) {
                Logger.getLogger(Lobby.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void btnVotar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotar1ActionPerformed
        try {
                ClienteHilo.enviarMensajeServidor("1");
            } catch (IOException ex) {
                Logger.getLogger(Lobby.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void btnVotar0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotar0ActionPerformed
            try {
                ClienteHilo.enviarMensajeServidor("0");
            } catch (IOException ex) {
                Logger.getLogger(Lobby.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void desbloquearEmpezar(){
        if (labelVotos.getText().equals("1")) {
    ...
    public void votar(int jugador) {
        if (botones[jugador].getText().equals("Votar Empezar Partida")) {
            votos++;
            labelVotos.setText(String.valueOf(votos));
            botones[jugador].setText("Cancelar Voto");
            paneles[jugador].setBackground(Color.green);
        }else if (botones[jugador].getText().equals("Cancelar Voto")) {
            votos--;
            labelVotos.setText(String.valueOf(votos));
            botones[jugador].setText("Votar Empezar Partida");
            paneles[jugador].setBackground(Color.red);
        }
        desbloquearEmpezar();
    }
